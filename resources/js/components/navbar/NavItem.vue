...
<template>
    <ul
        class="flex flex-col p-4 mt-4 font-medium capitalize transition-all duration-1000 border border-gray-100 rounded-lg md:p-0 bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
